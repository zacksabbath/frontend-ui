...
interface IImageButtonWrapperProps {
  backgroundImage: string;
}

const ImageButtonWrapper = styled.div<IImageButtonWrapperProps>`
  border-radius: 35px;
  flex: 1 1 200px;
...
export default function ImageButton(props: IImageButtonProps) {
